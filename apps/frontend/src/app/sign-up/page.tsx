          ...
          <div className="relative bg-white rounded-xl border-2 border-dashed border-stone-800 p-7">
            <AnimatePresence mode="wait">
                ...
                <div> error</div>
                  ...
                  {/* Button — only whileTap kept, staggered fade removed */}
                  <motion.button
                    whileTap={{ scale: 0.97 }}
                    onClick={submit}
                  ...
                  >
                    {loading ? "✏️ Creating..." : "Create my account →"}
                  </motion.button>

                  <p className="mt-3 text-center font-caveat text-sm text-stone-400">
                    Already have an account?{" "}
                    <Link href="/sign-in" className="text-amber-600 font-semibold underline decoration-wavy cursor-pointer">Log in →</Link>
                  </p>
                </motion.div>
